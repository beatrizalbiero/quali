...
\input{ch01-historicoescolar.tex}
\input{ch02-atividadesacademicas.tex}

\part{Projeto de Dissertação}
\input{ch03-introduction}
\input{ch04-background}
\input{ch05-preliminaryresults}

\part{Próximos Passos}
\input{ch06-future}

\part{Apêndice}
\input{ch07-appendice}
