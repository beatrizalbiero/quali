...
% operations =========
% phon features 1
\node[textonly] (1pho1) {[-consonantal, +consonantal]};
...
% phon features 2
\node[textonly, right=5pt of y1] (2pho1) {[-consonantal,+consonantal]};
\node[textonly, above=10pt of 2pho1] (leg2) {Unidades de Output};
\node[textonly, left=25pt of x2] (1pho2) {recuado-nasal]};
\node[textonly, right=25pt of y2] (2pho2) {recuado-nasal]};
\node[textonly, left=25pt of x3] (3pho1) {...};
\node[textonly, right=25pt of y3] (1pho3) {...};
\node[textonly, left=25pt of x6] (6pho1) {nasal-contínuo]};
\node[textonly, right=25pt of y6] (1pho6) {nasal-contínuo]};
% edges FNN
\path[nedge] (x1) -- (y1);
\path[nedge] (x1) -- (y2);
\path[nedge] (x1) -- (y3);
